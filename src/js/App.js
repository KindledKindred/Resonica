          ...
          _createClass(App, [{
              ...
              value: function animateText() {
                ...
                ui.textNodes.forEach(function (el, elIndex) {
                  ...
                  var _loop = function _loop(i) {
                    var _ref = [letters[i], letters[letters.length - i]],
                      letter1 = _ref[0],
                      letter2 = _ref[1];
            ...
            },
            {
              ...
              value: function updatePlane() {
                ...
                plane.cells = [
                  Math.round(w / plane.xCell),
                  Math.round(h / plane.yCell)
                ];
            ...
            },
            {
              ...
              value: function getTextPixels() {
                ...
                var imageData = ctx.getImageData(0, 0, doc.width, doc.height)
                  .data;
                state.textPixelData = [];
                var offset = 10;
            ...
            },
            {
              ...
              value: function startGeneratingNumbers() {
                ...
                function generateItem() {
                  ...
                  var timeToNewItem =
                    tools.random(1 + 50 * (1 - mp), 5 + 100 * (1 - mp)) /
                    state.area;
                  var item = {
                    p: 0,
            ...
            },
            {
              ...
              value: function startGeneratingLines() {
                ...
                function generateItem() {
                  ...
                  var mp = state.mousePower;
                  var timeToNewItem =
                    tools.random(25 + 80 * (1 - mp), 75 + 1200 * (1 - mp)) /
                    state.area;
                  var item = {
                    p: 0,
            ...
            },
            {
              ...
              value: function startGeneratingGlitches() {
                ...
                function generateItem() {
                  ...
                  var mp = state.mousePower;
                  var timeToNewItem = tools.random(
            ...
            },
            {
              ...
              value: function drawMouseMoveInteraction(props) {
                ...
                var mouseRange =
                  (200 + 50 * mp) *
                  ((i * i2) % 2) *
                  Math.sin(position[0] - position[1]);
                ...
                if (vector <= mouseRange) {
                  ...
                  var xOffset =
                    ...
                    ((i + i2) % 4 == 0 ? -1 : 1);
                  var yOffset =
                    Math.cos(sp + i2) * spinRadius * ((Math.PI * 2) / 4);
                  ...
                  var vector2 = tools.getVectorLength(
                    [sx, sy],
                    [mouse.x, mouse.y]
                  );
            ...
            },
            {
              ...
              value: function drawMarkupYAnimation(props) {
                ...
                var sp =
                  spSin >= 0 ? tools.cellEasing(Math.abs(spSin), 0, 1, 1) : 0;
